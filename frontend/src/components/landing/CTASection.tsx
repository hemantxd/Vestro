...
export default function CTASection() {
  return (
    <section id="cta" className="relative py-32 sm:py-40 bg-background overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted max-w-md mx-auto mb-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-10 py-4 rounded-full border border-line text-foreground hover:text-foreground hover:border-white/40 text-base font-medium transition-all duration-200"
            >
