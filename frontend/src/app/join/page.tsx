  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-4">Join the Beta</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-full bg-white/5 border border-line text-foreground placeholder:text-muted-2 text-sm focus:outline-none focus:border-[#00C853]/50 transition-colors"
          />
        ...
        <p className="mt-4 text-xs text-faint">No spam. Unsubscribe anytime.</p>
      </div>
    </div>
  );
}