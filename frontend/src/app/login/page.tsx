  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-2xl font-bold text-foreground text-center mb-8">Sign in to Vestro</h1>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs text-muted-2">or sign in with email</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-right mt-1">
              <Link href="/forgot-password" className="text-xs text-[#00C853]/70 hover:text-[#00C853] transition-colors">
                Forgot password?
              </Link>
            </div>
          </div>
