  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-2xl font-bold text-foreground text-center mb-8">Create your account</h1>
        ...
        <div className="mb-6">
          {googleLoading ? (
            <div className="w-full py-3 rounded-lg bg-white/5 border border-line flex items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs text-muted-2">or sign up with email</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-sm text-muted mb-1.5">Username</label>
            <input
              id="username"
              type="text"
              value={username}
          ...
          <div>
            <label htmlFor="reg-email" className="block text-sm text-muted mb-1.5">Email</label>
            <input
              id="reg-email"
              type="email"
              value={email}
          ...
          <div>
            <label htmlFor="reg-password" className="block text-sm text-muted mb-1.5">Password</label>
            <input
              id="reg-password"
              type="password"
              value={password}
          ...
          <div>
            <label htmlFor="displayName" className="block text-sm text-muted mb-1.5">Display name (optional)</label>
            <input
              id="displayName"
              type="text"
              value={displayName}
